...
<div class="modal fade" id="up_modal" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header_log" style="padding:35px 50px;">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4><span class="glyphicon glyphicon-lock"></span> Update Profile</h4>
            </div>
            <div class="modal-body" style="padding:40px 50px;">
                    <div class="form-group">
                        <label for="email_up"><span class="glyphicon glyphicon-user"></span> User Email</label>
                        <input type="text" class="form-control" id="email_up" placeholder="Enter email" value="<?php echo $user['user_email']?>"><p id="ErrorEmail_up" hidden="true" style="color:red;">The User Email Not True</p>
                    </div>
                <div class="form-group">
                    <label for="user_name_up"><span class="glyphicon glyphicon-user"></span> User Name</label>
                    <input type="text" class="form-control" id="user_name_up" placeholder="Enter User Name" value="<?php echo $user['user_name']?>"><p id="ErrorName_up" hidden="true" style="color:red;">The User Email Not True</p>
                </div>
                    <div class="form-group">
                        <label for="psw_up"><span class="glyphicon glyphicon-eye-open"></span> Password</label>
                        <input type="password" class="form-control" id="psw_up" placeholder="Enter password" required=" "><p id="ErrorPassword_up" hidden="true" style="color:red;">The Password Not True</p>
                    </div>

                <div class="form-group">
                    <label for="psw_up2"><span class="glyphicon glyphicon-eye-open"></span>Confirm Password</label>
                    <input type="password" class="form-control" id="psw_up2" placeholder="Confirm password" required=" "><p id="ErrorPassword_up2" hidden="true" style="color:red;">The Password Not True</p>
                </div>

                <button  class="btn btn-success btn-block" id="btn_update"><span class="glyphicon glyphicon-off"></span> Update</button>
            </div>
            <div class="modal-footer_log">
